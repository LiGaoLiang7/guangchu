<template>
    ...
    <div id="app">
        ...
        <f7-toolbar tabbar labels bottom class="app-main">
            ...
            <f7-link icon="iconfont icon-gaojing " class="toolicon" href="/warning/" :text="$t('app.toolbox.warning')" :class="{active : tabindex == 3}" @click="tabindex = 3"></f7-link>
...
export default {
    ...
    data (){
        return{
            ...
            // 控制柜实时数据
            params_ctrlcab : [
              { paramName : "PV1电压",              key : "PV1_VOL",      paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "PV1电流",              key : "PV1_CUR",      paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "PVI功率",              key : "PVI_PW",       paramValue : 0, byte : 2, unit : "W"  , resolution : 1   },
              { paramName : "PV2电压",              key : "PV2_VOL",      paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "PV2电流",              key : "PV2_CUR",      paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "PV2功率",              key : "PV2_PW",       paramValue : 0, byte : 2, unit : "W"  , resolution : 1   },
              { paramName : "逆变A相电压",          key : "sys_SAP",      paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "逆变A相电流",          key : "sys_SRP",      paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "电网A相电压",          key : "sys_SAPP",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网AB线电压",         key : "Grid_APC",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网A相电流",          key : "Grid_APV",     paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "逆变B相电压",          key : "Grid_BPC",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "逆变B相电流",          key : "Grid_BPV",     paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "电网B相电压",          key : "Grid_CPC",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网BC线电压",         key : "Grid_BPV",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网B相电流",          key : "Invr_APC",     paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "逆变C相电压",          key : "Invr_APV",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "逆变C相电流",          key : "Invr_BPC",     paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "电网C相电压",          key : "Invr_CPV",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网CA线电压",         key : "Invr_CPC",     paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "电网C相电流",          key : "Invr_BPV",     paramValue : 0, byte : 2, unit : "A"  , resolution : 100 },
              { paramName : "电网频率",             key : "Grid_ABLV",    paramValue : 0, byte : 2, unit : "Hz" , resolution : 100 },
              { paramName : "功率因数",             key : "Grid_BCLV",    paramValue : 0, byte : 2, unit :  ""  , resolution : 1000},
              { paramName : "系统有功功率",         key : "Grid_CALV",    paramValue : 0, byte : 2, unit : "VA" , resolution : 1   },
              { paramName : "系统无功功率",         key : "Grid_F",       paramValue : 0, byte : 2, unit : "W"  , resolution : 1   },
              { paramName : "系统视在功率",         key : "PW_FC",        paramValue : 0, byte : 2, unit : "Var", resolution : 1   },
              { paramName : "电池电流",             key : "Bty_C",        paramValue : 0, byte : 2, unit : "A"  , resolution : 10  },
              { paramName : "电池电压",             key : "Bty_V",        paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "直流正母线电压",       key : "DC_PBUS_V",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "直流负母线电压",       key : "DC_NBUS_V",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "直流双边母线电压",     key : "DC_BBUS_V",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "直流功率",             key : "DC_PW",        paramValue : 0, byte : 2, unit : "W"  , resolution : 1   },
              { paramName : "环境温度",             key : "Amb_temp",     paramValue : 0, byte : 2, unit : "℃" , resolution : 100 },
              { paramName : "铅酸电池剩余容量",     key : "LL_Bry_RCAP",  paramValue : 0, byte : 2, unit : "%"  , resolution : 1   },
              { paramName : "铅酸电池剩余备电时间", key : "LL_Bry_RTIME", paramValue : 0, byte : 2, unit : "Min", resolution : 1   },
              { paramName : "设备类型编码",         key : "DVC_T_CODE",   paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "软件版本号高位",       key : "Soft_V_H",     paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "软件版本号低位",       key : "Soft_V_L",     paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "并机地址",             key : "Para_Addr",    paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "工作效率",             key : "Work_Effc",    paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "充电次数",             key : "Cge_Time",     paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "放电次数",             key : "Num_dsc",      paramValue : 0, byte : 2, unit : ""   , resolution : 1   },
              { paramName : "模块A1 温度",          key : "Module_A1",    paramValue : 0, byte : 2, unit : "℃" , resolution : 10  },
              { paramName : "模块B1 温度",          key : "Module_B1",    paramValue : 0, byte : 2, unit : "℃" , resolution : 10  },
              { paramName : "模块C1 温度",          key : "Module_C1",    paramValue : 0, byte : 2, unit : "℃" , resolution : 10  },
              { paramName : "Backup输出A相电压",    key : "Bck_O_APV",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "Backup输出B相电压",    key : "Bck_O_BPV",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "Backup输出C相电压",    key : "Bck_O_CPV",    paramValue : 0, byte : 2, unit : "V"  , resolution : 10  },
              { paramName : "Backup输出频率",       key : "Bck_O_F",      paramValue : 0, byte : 2, unit : "Hz" , resolution : 100 },
              { paramName : "Backup输出A相电流",    key : "Bck_O_APC",    paramValue : 0, byte : 2, unit : "A" ,  resolution : 10  },
              { paramName : "Backup输出B相电流",    key : "Bck_O_BPB",    paramValue : 0, byte : 2, unit : "A" ,  resolution : 10  },
              { paramName : "Backup输出C相电流",    key : "Bck_O_CPC",    paramValue : 0, byte : 2, unit : "A" ,  resolution : 10  },
              { paramName : "Backup输出功率因数",   key : "Bck_O_PF",     paramValue : 0, byte : 2, unit : "" ,   resolution : 1000},
              { paramName : "Backup输出有功功率",   key : "Bck_O_AP",     paramValue : 0, byte : 2, unit : "VA",  resolution : 1   },
              { paramName : "Backup输出无功功率",   key : "Bck_O_RP",     paramValue : 0, byte : 2, unit : "Var", resolution : 1   },
              { paramName : "Backup输出视在功率",   key : "Bck_O_APP",    paramValue : 0, byte : 2, unit : "W" ,  resolution : 1   }
            ],
