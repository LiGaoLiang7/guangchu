...
import { f7Navbar, f7Page, f7BlockTitle } from 'framework7-vue';
  export default {
    ...
    data : function(){
      return {
        datalist : [
          { paramName : "直流功率",             key : "PV1_VOL",      paramValue : 0, byte : 2, unit : "W"  , isshow : 1, resolution : 10  },
          { paramName : "直流正母线电压",       key : "PV1_CUR",      paramValue : 0, byte : 2, unit : "V"  , isshow : 1, resolution : 100 },
          { paramName : "直流负母线电压",       key : "PVI_PW",       paramValue : 0, byte : 2, unit : "V"  , isshow : 1, resolution : 1   },
          { paramName : "直流双边母线电压",     key : "PV2_VOL",      paramValue : 0, byte : 2, unit : "V"  , isshow : 1, resolution : 10  },
          { paramName : "PV1电压",              key : "PV2_CUR",      paramValue : 0, byte : 2, unit : "V"  , isshow : 1, resolution : 100 },
          { paramName : "PV1电流",              key : "PV2_PW",       paramValue : 0, byte : 2, unit : "A"  , isshow : 1, resolution : 1   },
          { paramName : "PVI功率",              key : "sys_SAP",      paramValue : 0, byte : 2, unit : "W"  , isshow : 1, resolution : 10  },
          { paramName : "PV2电压",              key : "sys_SRP",      paramValue : 0, byte : 2, unit : "V"  , isshow : 1, resolution : 100 },
          { paramName : "PV2电流",              key : "sys_SAPP",     paramValue : 0, byte : 2, unit : "A"  , isshow : 1, resolution : 10  },
          { paramName : "PV2功率",              key : "Grid_APC",     paramValue : 0, byte : 2, unit : "W"  , isshow : 1, resolution : 10  },
          { paramName : "逆变A相电压",          key : "Grid_APV",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 100 },
          { paramName : "逆变A相电流",          key : "Grid_BPC",     paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 10  },
          { paramName : "电网A相电压",          key : "Grid_BPV",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 100 },
          { paramName : "电网AB线电压",         key : "Grid_CPC",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 10  },
          { paramName : "电网A相电流",          key : "Grid_BPV",     paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 10  },
          { paramName : "逆变B相电压",          key : "Invr_APC",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 100 },
          { paramName : "逆变B相电流",          key : "Invr_APV",     paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 10  },
          { paramName : "电网B相电压",          key : "Invr_BPC",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 100 },
          { paramName : "电网BC线电压",         key : "Invr_CPV",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 10  },
          { paramName : "电网B相电流",          key : "Invr_CPC",     paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 10  },
          { paramName : "逆变C相电压",          key : "Invr_BPV",     paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 100 },
          { paramName : "逆变C相电流",          key : "Grid_ABLV",    paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 100 },
          { paramName : "电网C相电压",          key : "Grid_BCLV",    paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 1000},
          { paramName : "电网CA线电压",         key : "Grid_CALV",    paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 1   },
          { paramName : "电网C相电流",          key : "Grid_F",       paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 1   },
          { paramName : "电网频率",             key : "PW_FC",        paramValue : 0, byte : 2, unit : "Hz" , isshow : 0, resolution : 1   },
          { paramName : "功率因数",             key : "Bty_C",        paramValue : 0, byte : 2, unit :  ""  , isshow : 0, resolution : 10  },
          { paramName : "系统有功功率",         key : "Bty_V",        paramValue : 0, byte : 2, unit : "VA" , isshow : 0, resolution : 10  },
          { paramName : "系统无功功率",         key : "DC_PBUS_V",    paramValue : 0, byte : 2, unit : "W"  , isshow : 0, resolution : 10  },
          { paramName : "系统视在功率",         key : "DC_NBUS_V",    paramValue : 0, byte : 2, unit : "Var", isshow : 0, resolution : 10  },
          { paramName : "电池电流",             key : "DC_BBUS_V",    paramValue : 0, byte : 2, unit : "A"  , isshow : 0, resolution : 10  },
          { paramName : "电池电压",             key : "DC_PW",        paramValue : 0, byte : 2, unit : "V"  , isshow : 0, resolution : 1   },
